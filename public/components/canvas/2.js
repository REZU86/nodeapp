(function() {
 window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1)}}();
 let canvaNUM = 2;
 let githublink = "htht";
  let title = "black hole";
  functions[canvaNUM] = [loop, false, githublink, title];
document.onselectstart = function() {
  return false;
};
var c = document.getElementById(canvaNUM);
